...
class WebConsoleTests(unittest.TestCase):
    ...
    def test_console_shell_exposes_rankings_and_guide(self):
        ...
        self.assertIn('id="addProfile"', html)
        self.assertIn("Add profile", html)
        self.assertIn("Create profile", html)
        self.assertIn("Gmail plus-address", html)
        ...
        self.assertIn("defaultSubscriptionEmail", app_js)
        self.assertIn("Fill out the form to create a new profile.", app_js)
